package com.github.catdou.export.excel;
...
public class ExcelExportTest extends ExportTest {
    ...
    public void testExcel2003() {
        ...
        List<User> userList = createDataList(CommonConstants.EXCEL_MAX_ROW_XLS * 2);
    ...
    public void testExcel2007() {
        ...
        List<User> userList = createDataList(CommonConstants.EXCEL_MAX_ROW_XLSX * 2);
        BaseExport baseExport = new ExcelExport(filePath, null, false, exportParam);
        baseExport.exportList(userList);
    }
    ...
    public void testManySheet() {
        ...
        List<User> userList = createDataList(CommonConstants.EXCEL_MAX_ROW_XLSX * 3);
